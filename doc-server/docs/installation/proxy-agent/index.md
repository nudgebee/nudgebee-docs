...
The Proxy Agent (called **Forager**) is a lightweight binary that runs on a VM, container, or Kubernetes pod in your infrastructure. It connects to NudgeBee over a secure WebSocket and acts as a bridge between NudgeBee and your datasources.
