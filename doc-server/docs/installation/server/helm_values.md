...
| nudgebee_secret.AUTH_DEFAULT_ROLE | string | `"tenant_admin_readonly"` | During self-onboarding via the authentication system, users can be assigned either the tenant_admin_readonly or tenant_admin roles. |
