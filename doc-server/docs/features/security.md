...
## Authentication
- Supports Google, Azure, Okta, and Auth0 for Single Sign-On (SSO). To configure SSO for on-prem, see [Authentication Integration](/docs/integrations/Authentication/).
