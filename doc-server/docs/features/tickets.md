...
1. [Jira](../integrations/Tickets/jira.md)
2. [GitHub Issues](../integrations/Tickets/github_issues.md)
3. [GitLab Issues](../integrations/Tickets/gitlab.md)
4. [ServiceNow](../integrations/Tickets/servicenow.md)
5. [PagerDuty](../integrations/Tickets/pagerduty.md)
6. [Zenduty](../integrations/Tickets/zenduty.md)
