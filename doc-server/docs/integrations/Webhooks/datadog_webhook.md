...
If a [Datadog observability integration](../Observability/datadog.md) is also configured for the same account, NudgeBee automatically enriches each alert event with:
