...
|-------------|-------------|
| [Datadog Webhook](./datadog_webhook) | Receive Datadog monitor alert notifications enriched with related telemetry data. |
| [New Relic Webhook](./newrelic_webhook) | Receive New Relic alert notifications enriched with logs, traces, and entity details. |
| [ServiceNow Webhook](./servicenow_webhook) | Receive ServiceNow incident notifications into NudgeBee. |
